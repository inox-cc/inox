...
function(inox_add_executable target)
  ...
  if(INOX_PREGENERATED)
    if(NOT EXISTS "${INOX_TARGET_MANIFEST}")
      message(FATAL_ERROR
        "inox_add_executable(${target}) PREGENERATED requires an existing manifest: ${INOX_TARGET_MANIFEST}"
      )
    endif()
  else()
    execute_process(
  ...
  if(INOX_PREGENERATED)
    set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${INOX_TARGET_MANIFEST}")
  else()
    set_property(

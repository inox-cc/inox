...
export function registerHttpRuntimeImportNames(context: CEmitContext, irPrograms: IrProgram[]): void {
  context.httpImportNames = collectStdlibRuntimeImportNames(irPrograms, 'http', 'module-object')
  context.httpCreateServerNames = collectStdlibRuntimeImportNames(irPrograms, 'http', 'create-server')
}

export function irProgramsUseHttpRuntimeImport(programs: IrProgram[]): boolean {
  return irProgramsUseStdlibRuntimeImport(programs, 'http')
}

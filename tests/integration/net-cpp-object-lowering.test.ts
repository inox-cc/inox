...
`
  ...
  assert.match(header, /typedef void \(\*NetSocketWriteFn\)\(void\* user, NetSocket socket, inox_status status\);/)
  assert.doesNotMatch(header, /NetSocketWriteFn\)\(void\* user, inox_net_socket\* socket/)
  assert.match(header, /typedef void \(\*NetSocketErrorFn\)\(void\* user, NetSocket socket, inox_status status\);/)
  ...
  assert.match(header, /typedef void \(\*NetConnectFn\)\(void\* user, NetSocket socket, inox_status status\);/)
  ...
  assert.match(header, /typedef void \(\*NetServerErrorFn\)\(void\* user, NetServer server, inox_status status\);/)

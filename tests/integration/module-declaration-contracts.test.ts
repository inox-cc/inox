...
import {
  ...
  moduleDeclarationExportValueType,
...
function assertStdlibDeclarationExportValueTypes(): void {
  ...
  assert.equal(moduleDeclarationExportValueType(bufferProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(bufferProgram, 'Buffer'), 'function')
  assert.equal(moduleDeclarationExportValueType(bufferProgram, 'constants'), 'object')
  assert.equal(moduleDeclarationExportValueType(bufferProgram, 'Uint8Array'), null)
  assert.equal(moduleDeclarationExportValueType(childProcessProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(childProcessProgram, 'execSync'), 'function')
  assert.equal(moduleDeclarationExportValueType(childProcessProgram, 'spawnSync'), 'function')
  assert.equal(moduleDeclarationExportValueType(cryptoProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(cryptoProgram, 'createHash'), 'function')
  assert.equal(moduleDeclarationExportValueType(cryptoProgram, 'Hash'), 'function')
  assert.equal(moduleDeclarationExportValueType(dgramProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(dgramProgram, 'createSocket'), 'function')
  assert.equal(moduleDeclarationExportValueType(dgramProgram, 'Socket'), 'function')
  assert.equal(moduleDeclarationExportValueType(eventsProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(eventsProgram, 'EventEmitter'), 'function')
  assert.equal(moduleDeclarationExportValueType(eventsProgram, 'defaultMaxListeners'), 'number')
  assert.equal(moduleDeclarationExportValueType(eventsProgram, 'once'), 'function')
  assert.equal(moduleDeclarationExportValueType(fsProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(fsProgram, 'constants'), 'object')
  assert.equal(moduleDeclarationExportValueType(fsProgram, 'readFileSync'), 'function')
  assert.equal(moduleDeclarationExportValueType(fsPromisesProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(fsPromisesProgram, 'readFile'), 'function')
  assert.equal(moduleDeclarationExportValueType(httpProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(httpProgram, 'Server'), 'function')
  assert.equal(moduleDeclarationExportValueType(httpProgram, 'createServer'), 'function')
  assert.equal(moduleDeclarationExportValueType(netProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(netProgram, 'Socket'), 'function')
  assert.equal(moduleDeclarationExportValueType(netProgram, 'connect'), 'function')
  assert.equal(moduleDeclarationExportValueType(osProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(osProgram, 'EOL'), 'string')
  assert.equal(moduleDeclarationExportValueType(osProgram, 'platform'), 'function')
  assert.equal(moduleDeclarationExportValueType(pathProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(pathProgram, 'posix'), 'object')
  assert.equal(moduleDeclarationExportValueType(pathProgram, 'join'), 'function')
  assert.equal(moduleDeclarationExportValueType(processProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(processProgram, 'arch'), 'string')
  assert.equal(moduleDeclarationExportValueType(processProgram, 'cwd'), 'function')
  assert.equal(moduleDeclarationExportValueType(processProgram, 'exitCode'), 'number')
  assert.equal(moduleDeclarationExportValueType(processProgram, 'pid'), 'number')
  assert.equal(moduleDeclarationExportValueType(streamProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(streamProgram, 'Readable'), 'function')
  assert.equal(moduleDeclarationExportValueType(streamProgram, 'finished'), 'function')
  assert.equal(moduleDeclarationExportValueType(streamProgram, 'promises'), 'object')
  assert.equal(moduleDeclarationExportValueType(timersProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(timersProgram, 'setTimeout'), 'function')
  assert.equal(moduleDeclarationExportValueType(urlProgram, 'default'), 'object')
  assert.equal(moduleDeclarationExportValueType(urlProgram, 'URL'), 'function')
  assert.equal(moduleDeclarationExportValueType(urlProgram, 'fileURLToPath'), 'function')
}

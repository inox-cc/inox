...
`
  ...
  assert.match(result.code, /#include "inox\/value\.hpp"/)
...
`
  ...
  assert.match(result.code, /inox_map_size\(this->scores\.raw\(\)/)
...
`
  ...
  assert.match(result.code, /inox_set_size\(this->tags\.raw\(\)/)

...
`
  ...
  assert.match(source, /auto inox_library_result_\d+ = Object\.entries\(inox_value_\d+\);/)
  assert.match(source, /auto inox_library_result_\d+ = Object\.values\(inox_value_\d+\);/)
  assert.match(source, /auto inox_library_result_\d+ = Object\.keys\(inox_value_\d+\);/)
  assert.match(source, /console\.log\(inox_library_result_\d+\);/)

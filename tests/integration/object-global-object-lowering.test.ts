...
`
  ...
  assert.match(source, /console\.log\(Object\.entries\(inox::get\(foo, "v"\)\)\);\n  if \(inox::thrown\(\)\) return;/)
  assert.match(source, /console\.log\(Object\.values\(inox::get\(foo, "v"\)\)\);\n  if \(inox::thrown\(\)\) return;/)
  assert.match(source, /console\.log\(Object\.keys\(inox::get\(foo, "v"\)\)\);\n  if \(inox::thrown\(\)\) return;/)

...
`
  ...
  assert.match(source, /Array inox_array_\d+ = Array::create\(3\);/)
  assert.match(source, /inox_array_\d+\.set\(0, inox_number_value\(1\)\);/)
  assert.match(source, /inox_array_\d+\.set\(1, inox_number_value\(2\)\);/)
  assert.match(source, /inox_array_\d+\.set\(2, inox_number_value\(3\)\);/)
  ...
  assert.match(source, /Array inox_array_\d+ = Array::create\(1\);/)
  assert.match(source, /inox_array_\d+\.set\(0, inox_number_value\(1\)\);/)

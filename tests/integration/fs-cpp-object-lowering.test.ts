...
`
  ...
  assert.match(header, /typedef FsStats \(\*FsStatFn\)\(void\* user, inox::StringView path\);/)
  ...
  assert.doesNotMatch(header, /typedef inox_status \(\*FsStatFn\)/)
  assert.doesNotMatch(header, /FsStatFn\)\([^;]*inox_allocator\* allocator/)
  assert.doesNotMatch(header, /FsStatFn\)\([^;]*inox_value\* out/)

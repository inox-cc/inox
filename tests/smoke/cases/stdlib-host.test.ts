...
// @stdout url:example.com:/docs:q=inox&kind=host
...
const syncFile = '/private/tmp/inox-smoke-sync-' + String(process.pid) + '.txt'
const asyncFile = '/private/tmp/inox-smoke-async-' + String(process.pid) + '.txt'

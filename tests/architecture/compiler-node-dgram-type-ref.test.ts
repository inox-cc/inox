...
const expectedResults = [
  ...
  ['node:dgram#Socket.addMembership', socketTypeRef()],
  ...
  ['node:dgram#Socket.dropMembership', socketTypeRef()],
  ['node:dgram#Socket.getRecvBufferSize', primitiveTypeRef('number')],
  ['node:dgram#Socket.getSendBufferSize', primitiveTypeRef('number')],
  ['node:dgram#Socket.getSendQueueCount', primitiveTypeRef('number')],
  ['node:dgram#Socket.getSendQueueSize', primitiveTypeRef('number')],
  ...
  ['node:dgram#Socket.setMulticastInterface', socketTypeRef()],
  ['node:dgram#Socket.setMulticastLoopback', socketTypeRef()],
  ['node:dgram#Socket.setMulticastTTL', socketTypeRef()],

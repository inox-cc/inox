...
export function anyNodeObjectShape(loc: SourceLocation): ObjectShapeInfo {
  ...
  return {
    ...
    fields: [
      ...
      anyNodeField('defaultType', 'string', null, true, loc),
      ...
      anyNodeField('typePredicateParameterName', 'string', null, true, loc),
      anyNodeField('typePredicateType', 'string', null, true, loc),
      ...
      anyNodeField('libraryCCoroutineAwaitExpression', 'string', null, true, loc),
      ...
      anyNodeField('libraryCHasObservableSideEffects', 'boolean', null, false, loc),
      ...
      anyNodeField('argumentNarrowing', 'object', null, true, loc),
      anyNodeField('typePredicateLoc', 'object', null, true, loc, { shape: anyNodeLocObjectShape(loc) }),

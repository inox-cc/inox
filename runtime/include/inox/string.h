...
public:
  ...
  String concat(const StringView* values, size_t count) const;
  ...
  bool startsWith(StringView search, double position) const;
  bool endsWith(StringView search) const;
  bool endsWith(StringView search, double end_position) const;

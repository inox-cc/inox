...
typedef ccjs_status (*ccjs_fs_string_path_fn)(
  void* user,
  ccjs_allocator* allocator,
  const char* path,
  size_t path_len,
...
typedef ccjs_status (*ccjs_fs_symlink_fn)(
  void* user,
  const char* target,
  size_t target_len,
  const char* path,
...
typedef struct ccjs_fs_adapter {
  ...
  ccjs_fs_string_path_fn realpath;
  ccjs_fs_string_path_fn readlink;
